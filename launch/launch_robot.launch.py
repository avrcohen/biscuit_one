...
def generate_launch_description():
    ...
    launch_arguments_rsp = {'use_sim_time': 'false', 'use_ros2_control': 'true'}
    ...
    # Launch!
    return LaunchDescription([rsp, delayed_controller_manager, delayed_diff_drive_spawner, delayed_joint_broad_spawner])